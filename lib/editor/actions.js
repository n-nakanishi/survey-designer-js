...
export function changeItemVisibilityCondition(questionId, itemId, attributeName, value) {
  return { type: C.CHANGE_ITEM_VISIBILITY_CONDITION, questionId, itemId, attributeName, value };
}
