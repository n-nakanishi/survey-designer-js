...
export function changeItemVisibilityCondition(questionId, itemId, value) {
  return { type: C.CHANGE_ITEM_VISIBILITY_CONDITION, questionId, itemId, value };
}
export function changeSubItemVisibilityCondition(questionId, itemId, value) {
  return { type: C.CHANGE_SUB_ITEM_VISIBILITY_CONDITION, questionId, itemId, value };
}
