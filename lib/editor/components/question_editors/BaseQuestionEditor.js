...
import { Button, Col, FormGroup, ControlLabel, Checkbox, FormControl, InputGroup } from 'react-bootstrap';
...
import ItemVisibilityEditorDialog from './parts/ItemVisibilityEditorDialog';
...
class BaseQuestionEditor extends Component {
  constructor(props) {
    ...
    this.state = {
      showItemVisibilityEditorDialog: false,
      showSubItemVisibilityEditorDialog: false,
    };
  }
  ...
  /** itemVisibilityEditorDialogの表示ハンドラ */
  handleShowItemVisibilityEditorDialog() {
    this.setState({ showItemVisibilityEditorDialog: true });
  }
            ...
            <Col componentClass={ControlLabel} md={2}>
              ...
              <div>
                <Button
                  bsSize="xsmall"
                  bsStyle="success"
                  onClick={() => this.setState({ showItemVisibilityEditorDialog: true })}
                >表示制御</Button>
              </div>
            </Col>
            <Col md={10}>
              <div className="item-editor">
                ...
                <ItemVisibilityEditorDialog
                  show={this.state.showItemVisibilityEditorDialog}
                  items={question.getItems()}
                  onHide={() => this.setState({ showItemVisibilityEditorDialog: false })}
                  {...this.props}
                />
              </div>
            </Col>
            ...
            <Col componentClass={ControlLabel} md={2}>
              ...
              <div>
                <Button
                  bsSize="xsmall"
                  bsStyle="success"
                  onClick={() => this.setState({ showSubItemVisibilityEditorDialog: true })}
                >表示制御</Button>
              </div>
            </Col>
            <Col md={10}>
              <div className="item-editor">
                ...
                <ItemVisibilityEditorDialog
                  show={this.state.showSubItemVisibilityEditorDialog}
                  items={question.getSubItems()}
                  onHide={() => this.setState({ showSubItemVisibilityEditorDialog: false })}
                  {...this.props}
                />
              </div>
            </Col>
